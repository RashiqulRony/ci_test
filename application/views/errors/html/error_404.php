...
<body>
    <article>
        ...
        <div>
            ...
            <ul>
                <li>Start over at the home page : <a href="<?php echo site_url(); ?>" title="Doreen Power Ltd">Doreen Power Ltd</a></li>
                <li>Email us with what you're looking for : <a href="mailto:info@doreen.power.com" target="_blank">info@doreen.power.com</a></li>
            </ul>
