...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="<?php echo base_url('assets/frontend/img/fevicon.png') ?>" />
        <!-- Bootstrap core CSS -->
        ...
        <section id="container" >
            ...
            <header class="header">
                ...
                <a href="<?php echo admin_url(); ?>" class="logo" style="margin-top: 0px">
                    <img style="height: 45px;margin-top: 2px;" data-retina src="<?php echo base_url('assets/frontend/img/logo.png') ?>" alt="Logo" /></a>
                <!--logo end-->
