...
class Profile extends CI_Controller {
    ...
    public function dashboard() {
        ...
        $data['totalProjects'] = $this->global_model->countRow('projects');
        $data['totalProjectVideo'] = 0;
        ...
        /*
          $data['catalogGallery'] = $catalogGallery = $this->global_model->getDashboardGallery('catalogs', 4);
          $data['productRequests'] = $productRequests = $this->global_model->getProductRequestsDashboard(4);
          $data['totalProductRequests'] = $totalProductRequests = $this->global_model->countProductRequestsDashboard();
          $data['registeredUser'] = $registeredUser = $this->global_model->getRegisteredUserDashboard(4);
          $data['totalCatalog'] = $this->global_model->countRow('catalogs');
          $data['totalProduct'] = $this->global_model->countRow('product');
          $data['totalRequests'] = $this->global_model->countRow('product_requests');
         */
        // load the views
...
/* Location: ./application/controllers/doreenadmin/Profile.php */